...
async function getFile1(itemLotJob, authToken, item, outputPath) {
    ...
    sql.connect(conn).then(pool => {
        ...
        //     let dataUpload = fs.readFileSync('C:\\Users\\sreenath-umagandhi\\Documents\\TestFolder\\'+itemLotJob+'\\'+itemLotJob+' '+fileName+'.xlsm', response.data)
  ...
  //  let docID = "9420"
    ...
    /*                axios.post('https://immy2700.sharepoint.com/sites/production-automation/_api/web/GetFolderByServerRelativeURL' +
                        ...
                        .then(function (resp) {
                            ...
                            fetch('https://inforapp.immy.com/SLReports/Report/OutputFiles/sreenath-umagandhi@immy.com/CCGJobOperationListing_DIMMY_264946.pdf')
                                .then(res => res.buffer())
                                .then(buffer => {
